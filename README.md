...
![Build](https://github.com/yellowsand1/test-plugin/workflows/Build/badge.svg)
...
- Manually:
  ...
  Download the [latest release](https://github.com/yellowsand1/test-plugin/releases/latest) and install it manually using
